                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nik"  placeholder="Enter NIK" name="nik" value="{{ old('nik',$user->nik) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fullname" class="col-sm-3 col-form-label">Full Name<b class="text-danger">*</b></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="fullname"  placeholder="Enter Full Name" name="fullname" value="{{ old('fullname',$user->fullname) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="phone"  placeholder="Enter Phone" name="phone"  value="{{ old('phone',$user->phone) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label">Bank Name<b class="text-danger">*</b></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="bank_name"  placeholder="Enter Bank Name" name="bank_name"  value="{{ old('bank_name',$user->bank_name) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="bank_account" class="col-sm-3 col-form-label">Bank Account<b class="text-danger">*</b></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="bank_account"  placeholder="Enter Bank Account" name="bank_account"  value="{{ old('bank_account',$user->bank_account) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="has_npwp" name="has_npwp" value="1" @if(old('has_npwp',$user->has_npwp)=='1')
                                    checked=""
                                    @endif
                                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="3" id="address"  placeholder="Enter Address" name="address">{{ old('address',$user->address) }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="col-5">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="organization_id" class="form-control">
                                    ...
                                    <option value="{{ $or->id }}"  @if(old('organization_id',$user->organization_id)==$or->id)
                                        selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="role_id" class="form-control">
                                    @foreach($role as $rl)
                                    <option value="{{ $rl->id }}"  @if(old('role_id',$user->role_id)==$rl->id)
                                        selected
                        ...
                        <div class="form-group row">
                            <label for="password_update" class="col-sm-3 col-form-label">Password<b class="text-danger">*</b></label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="password_update"  placeholder="Enter Password" name="password_update"  >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password_update_confirmation" class="col-sm-3 col-form-label">Re-Password<b class="text-danger">*</b></label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="password_update_confirmation"  placeholder="Re-Type Password" name="password_update_confirmation">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="active" name="active" value="1"  @if(old('active',$user->active)=='1')
                                    checked=""
                                    @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="cti_usage" name="cti_usage" value="1"  @if(old('cti_usage',$user->cti_usage)=='1')
                                    checked=""
                                    @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="mobile_access" name="mobile_access" value="1"  @if(old('mobile_access',$user->mobile_access)=='1')
                                    checked=""
                                    @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="tmm" name="tmm" value="1" @if(old('tmm',$user->tmm)=='1')
                                    checked=""
                                    @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="limit_days"  placeholder="Enter Limit Days" name="limit_days" value="{{ old('limit_days',$user->limit_days) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="limit_amount" class="col-sm-3 col-form-label">Limit Amount</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="limit_amount"  placeholder="Enter Limit Amount" name="limit_amount" value="{{ old('limit_amount',$user->limit_amount) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="warehouse_id" class="form-control">
                                    @foreach($warehouse as $wr)
                                        <option value="{{ $wr->id }}"  @if(old('warehouse_id',$user->warehouse_id)==$wr->id)
                                            selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group ">
                                    <input class="form-control py-2 border-right-0 border" type="ERP Id" name="erp_id" id="example-search-input" value="{{ old('erp_id',$user->erp_id) }}">
...
<script>
    $(document).ready(function() {
       ...
       $("#postalcode_id").val(postalcode_id).change();
    })
 </script>
@stop